...
config_h_in = src/ncpufreqd_config.h.in
...
makefiles: configure Makefile.am src/Makefile.am progs/Makefile.am
	@echo rebuilding Makefile.in files
	$(AUTOMAKE) --add-missing --copy

clean:
	@rm -rf m4 src/*.lo src/*.la src/*.o src/*.a src/.libs src/.deps src/Makefile src/Makefile.in src/stamp-h1 src/ncpufreqd_config.h*
	rm -rf progs/Makefile progs/Makefile.in progs/stamp-h1
